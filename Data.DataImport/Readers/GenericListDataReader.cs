...
// ***********************************************************************
// <copyright file="GenericListDataReader.cs" company="Microsoft">
...
{
	/// <summary>
	/// Class GenericListDataReaderExtensions.
	/// </summary>
	public static class GenericListDataReaderExtensions
	{
		...
		/// <returns>GenericListDataReader&lt;T&gt;.</returns>
	...
	/// <summary>
	/// Class GenericListDataReader.
	/// </summary>
	/// <typeparam name="T"></typeparam>
	/// <seealso cref="System.Data.IDataReader" />
	/// <seealso cref="System.Data.IDataRecord" />
	/// <seealso cref="System.IDisposable" />
	public class GenericListDataReader<T> : IDataReader, IDataRecord, IDisposable
	{
		/// <summary>
		/// The _list
		/// </summary>
		private IEnumerator<T> _list = null;
		/// <summary>
		/// The _properties
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GenericListDataReader{T}"/> class.
		/// </summary>
		/// <param name="list">The list.</param>
		...
		public DataTable GetSchemaTable()
		{
			...
			{
				ret.Columns.Add(new DataColumn(prop.Name, prop.PropertyType));
			}
			return ret;
